          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                ...
                <div class="card-body ">
                  <form method="post" action="/updateDashBoard/${dashboard.content}" class="form-horizontal">
                   <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="${dashboard.content}">
                        </div>
                      </div>
                    </div>
                 	<div class="card-footer justify-content-center">
						<button type="submit" class="btn btn-rose btn-link btn-lg">Update</button>
					</div>
                  </form>
                  </div>
                </div>
